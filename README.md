...
>  Using data from the **2022 Tanzania Demographic and Health Survey (TDHS)**, this study investigates the socio-economic drivers of childhood malnutrition, stunting, underweight, and wasting. The analysis applies **survey-weighted logistic regression** to identify vulnerable populations among children under five.
...
![Outcomes by Wealth](Rplot04.png)
...
![Maternal Education](Rplot01.png)
*(Figure 2: Distribution of Maternal Education by Residence)*
...
![Adjusted Odds Ratios](Rplot10.png)
*(Table 1: Multivariable Logistic Regression Models for Stunting, Underweight, and Wasting)*

### 📝 Clinical Interpretation
The weighted logistic regression model reveals three critical determinants:
1.  **Male Vulnerability:** Male children significantly higher odds of all three malnutrition outcomes compared to females (**aOR for Stunting: 1.52**, 95% CI: 1.28–1.80).
